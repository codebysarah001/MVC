...
namespace mini_school_system.Controllers
{
    public class StudentsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,StudentName,ClassId")] Student student)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,StudentName,ClassId")] Student student)
        {
            if (ModelState.IsValid)
            {
